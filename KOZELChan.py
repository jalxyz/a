			...
			for yuzong in id2:
				...
				if len(nmf)<6:
					if len(frs)<3:
						...
						pwv.append('kalimantan')
						pwv.append('kalimantan123')
						pwv.append('binuang')
						pwv.append('binuang123')
						pwv.append('kalteng')
						pwv.append('kalteng123')
						pwv.append('kalimantanselatan')
						pwv.append('kalimantantengah')
						pwv.append('kalimantanbarat')
				else:
					if len(frs)<3:
						pwv.append(nmf)
					else:
